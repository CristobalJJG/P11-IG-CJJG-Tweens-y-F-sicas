...
//------------Nuevo------------------//
const convexBreaker = THREE.ConvexObjectBreaker;
...
function initInput() {
    window.addEventListener("pointerdown", function(event) {
        ...
        const ball = new THREE.SphereGeometry(ballRadius, 14, 10)
        ...
        quat.set(0, 0, 0, 1);
        const ballBody = createSoftVolume(ball, ballShape, ballMass, pos, quat);
...
function updatePhysics(deltaTime) {
    ...
    for (let i = 0, il = softBodies.length; i < il; i++) {
        ...
        //Actualiza los objetos rompibles
